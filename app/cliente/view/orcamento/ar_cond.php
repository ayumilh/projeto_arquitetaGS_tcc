      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-6">
            ...
            <div class="list-group w-auto h-auto" id="orcamento-divs">
              ...
              if ($query_row->num_rows > 0) {
                while ($row = $query_row->fetch_assoc()) {
                  ...
                  echo '
                      <div class="item-lista list-group-item list-group-item-action d-flex gap-3 py-3 mt-2" aria-current="true">
                        ...
                        <div class="d-flex w-100 justify-content-between">
                          ...
                          <button type="button" class="btn-selecao indeterminado" id="'.$row['id_servico'].'">Selecionar</button>
                        </div>
                      </div>';
                }
              } else {
